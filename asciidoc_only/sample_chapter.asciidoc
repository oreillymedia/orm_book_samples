...
First, go to the Dashboard tab of your book project. Then, look to the right panel, click the "PDF" box, and hit "Build". Atlas will take a moment to generate the pages. A "Download" button will appear - click this, and a PDF will open in your web browseer. This PDF may then be saved locally. 
...
In order to add a new chapter in Atlas, you'll need to make an adjustment to the Cofnigure tab in Atlas. 

. Move to the Configure tab in the book project in Atlas. 
. Scroll down to the middle section of the subsequent page under "Files". Find the chapter you'd like to add, and click the + symbol.  
...
. Once your contents list looks correct, scroll down the page to click the "Save Settings" button. 
.  Go back to the Dashboard tab, and repeat the steps to create a Book Build as discussed in the previous section. 
